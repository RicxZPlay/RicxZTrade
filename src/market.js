...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-15m", title: "BTC 15m", interval: "15m", historyLimit: 16000, fallbackSeconds: 900, type: "candles", bbColor: "#f472b6", bbMultiplier: 1, bbPeriod: 2000, extraBollingerBands: [{ color: "#38bdf8", period: 3000, multiplier: 2, showMiddle: true }, { color: "#7c3aed", period: 4000, multiplier: 3 }], showBollingerBands: true, showEma: false, showVwma: false },
