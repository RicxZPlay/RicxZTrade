...
export const BTC_RENKO_ONE_MINUTE_EMA_PERIOD = 450;
...
export const BTC_QUAD_CHARTS = [
  { id: "renko-1m", title: "BTC Renko 1m", interval: "1m", historyLimit: 5000, fallbackSeconds: 60, type: "renko", boxSize: 1, emaPeriod: BTC_RENKO_ONE_MINUTE_EMA_PERIOD, vwmaPeriod: BTC_RENKO_ONE_MINUTE_VWMA_PERIOD },
