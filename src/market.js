...
export const BTC_ONE_SECOND_VWMA_PERIOD = 1250;
export const BTC_ONE_SECOND_EXTRA_VWMA_PERIOD = 7000;
...
export const BTC_QUAD_CHARTS = [
  { id: "candles-1s", title: "BTC 1s", interval: "1s", historyLimit: 10000, fallbackSeconds: 1, type: "candles", bbMultiplier: BTC_ONE_SECOND_BB_MULTIPLIER, bbPeriod: BTC_ONE_SECOND_BB_PERIOD, extraVwmaColor: "#f8fafc", extraVwmaPeriod: BTC_ONE_SECOND_EXTRA_VWMA_PERIOD, showBollingerBands: true, showEma: false, vwmaColor: "#38bdf8", vwmaPeriod: BTC_ONE_SECOND_VWMA_PERIOD },
  ...
  { id: "candles-1h", title: "BTC 1H", interval: "1h", historyLimit: 1500, fallbackSeconds: 3600, type: "candles", maOffset: BTC_ONE_HOUR_MA_OFFSET, maPeriod: BTC_ONE_HOUR_MA_PERIOD },
