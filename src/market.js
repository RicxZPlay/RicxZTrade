...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-1m", title: "BTC 1m", interval: "1m", historyLimit: 10000, fallbackSeconds: 60, type: "candles", extraLsmaPeriods: [{ period: 3800, color: "#38bdf8" }], pivots: { type: "traditional", timeframe: "daily", periodsBack: 2, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false },
