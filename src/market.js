...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-1h", title: "BTC 1H", interval: "1h", historyLimit: 8500, fallbackSeconds: 3600, type: "candles", bbMultiplier: BTC_ONE_HOUR_SETUP_BB_MULTIPLIER, bbPeriod: BTC_SLOW_SETUP_BB_PERIOD, extraBollingerBands: [{ period: 5000, multiplier: 2 }], emaOffset: 0, emaPeriod: BTC_SLOW_EMA_PERIOD, lrcPeriod: 200, lsmaPeriod: BTC_SLOW_SETUP_LSMA_PERIOD, showBbMiddle: true, showBollingerBands: true, showVwma: false },
