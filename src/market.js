...
export const BTC_QUAD_CHARTS = [
  { id: "candles-1s", title: "BTC 1s", interval: "1s", historyLimit: 10000, fallbackSeconds: 1, type: "candles", bbMultiplier: BTC_ONE_SECOND_BB_MULTIPLIER, bbPeriod: BTC_ONE_SECOND_BB_PERIOD, extraVwmaColor: "#f8fafc", extraVwmaPeriod: BTC_ONE_SECOND_VWMA_PERIOD, maOffset: BTC_ONE_SECOND_MA_OFFSET, maPeriod: BTC_ONE_SECOND_MA_PERIOD, showBollingerBands: true, showEma: false, showVwma: false },
