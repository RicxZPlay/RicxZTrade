...
export const BTC_QUAD_CHARTS = [
  { id: "renko-30m", title: "BTC Renko 30m", interval: "30m", historyLimit: 18000, fallbackSeconds: 1800, type: "renko", boxSize: BTC_RENKO_THIRTY_MINUTE_BOX_SIZE, bbColor: "#7c3aed", bbMultiplier: 3, bbPeriod: 10000, extraBollingerBands: [{ color: "#38bdf8", middleColor: "#ffffff", period: 8000, multiplier: 2, showMiddle: true }], showBollingerBands: true, showBbMiddle: false, showEma: false, showVwma: false },
