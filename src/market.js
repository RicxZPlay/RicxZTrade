...
export const BTC_ONE_HOUR_SETUP_BB_MULTIPLIER = 2.001;
...
export const BTC_ONE_SECOND_LRC_PERIOD = 1500;
export const BTC_ONE_SECOND_LSMA_PERIOD = 3800;
...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-15m", title: "BTC 15m", interval: "15m", historyLimit: 11500, fallbackSeconds: 900, type: "candles", bbMultiplier: 1.001, bbPeriod: 10000, extraBollingerBands: [{ period: 8000, multiplier: 2 }, { period: 8000, multiplier: 3 }], lrcPeriod: 1500, lsmaPeriod: 3800, showBollingerBands: true, showEma: false, showVwma: false },
  { id: "renko-1h", title: "BTC Renko 1H", interval: "1h", historyLimit: 8500, fallbackSeconds: 3600, type: "renko", boxSize: 5, bbMultiplier: 3, bbPeriod: 8000, lsmaPeriod: 5500, projectedDownColor: "#f59e0b", projectedUpColor: "#38bdf8", showBollingerBands: true, showEma: false, showVwma: false, visibleBars: 5000 },
  { id: "candles-1h", title: "BTC 1H", interval: "1h", historyLimit: 8500, fallbackSeconds: 3600, type: "candles", bbMultiplier: BTC_ONE_HOUR_SETUP_BB_MULTIPLIER, bbPeriod: BTC_SLOW_SETUP_BB_PERIOD, emaOffset: 0, emaPeriod: BTC_SLOW_EMA_PERIOD, lrcPeriod: 200, lsmaPeriod: BTC_SLOW_SETUP_LSMA_PERIOD, showBbMiddle: true, showBollingerBands: true, showVwma: false },
