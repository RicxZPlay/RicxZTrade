...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-15m-lsma", title: "BTC 5m", interval: "5m", historyLimit: 12000, fallbackSeconds: 300, type: "candles", maPeriod: 800, extraLsmaPeriods: [{ period: 1700, color: "#a78bfa" }, { period: 3800, color: "#f8fafc" }], pivots: { type: "woodie", timeframe: "monthly", periodsBack: 3, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false, visibleBars: 450 },
