...
export const BTC_QUAD_CHARTS = [
  { id: "candles-1m", title: "BTC 1m", interval: "1m", historyLimit: 1500, fallbackSeconds: 60, type: "candles", emaPeriod: BTC_ONE_MINUTE_EMA_PERIOD, vwmaPeriod: BTC_ONE_MINUTE_VWMA_PERIOD },
