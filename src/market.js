...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-1m", title: "BTC 15m", interval: "15m", historyLimit: 10000, fallbackSeconds: 900, type: "candles", extraLsmaPeriods: [{ period: 3800, color: "#38bdf8" }], pivots: { type: "woodie", timeframe: "monthly", periodsBack: 2, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false },
