...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-15m-lsma", title: "BTC 1H", interval: "1h", historyLimit: 12000, fallbackSeconds: 3600, type: "candles", extraLsmaPeriods: [{ period: 3800, color: "#f8fafc" }], pivots: { type: "woodie", timeframe: "monthly", periodsBack: 3, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false, visibleBars: 450 },
  ...
  { id: "candles-1m", title: "BTC 15m", interval: "15m", historyLimit: 10000, fallbackSeconds: 900, type: "candles", extraLsmaPeriods: [{ period: 3800, color: "#38bdf8" }], pivots: { type: "traditional", timeframe: "daily", periodsBack: 2, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false },
