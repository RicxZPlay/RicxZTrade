...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-1m", title: "BTC 1m", interval: "1m", historyLimit: 10000, fallbackSeconds: 60, type: "candles", bbMultiplier: BTC_ONE_MINUTE_BB_MULTIPLIER, bbPeriod: BTC_ONE_MINUTE_BB_PERIOD, extraBollingerBands: [{ color: "#38bdf8", period: 3000, multiplier: 2 }], showBbMiddle: true, showBollingerBands: true, showEma: false, showVwma: false },
  ...
  { id: "candles-1h", title: "BTC 1H", interval: "1h", historyLimit: 16000, fallbackSeconds: 3600, type: "candles", bbMultiplier: BTC_ONE_HOUR_SETUP_BB_MULTIPLIER, bbPeriod: BTC_SLOW_SETUP_BB_PERIOD, extraBollingerBands: [{ color: "#38bdf8", period: 5000, multiplier: 2 }], emaOffset: 0, emaPeriod: BTC_SLOW_EMA_PERIOD, lsmaPeriod: BTC_SLOW_SETUP_LSMA_PERIOD, showBbMiddle: true, showBollingerBands: true, showVwma: false },
