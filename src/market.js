...
export const BTC_QUAD_CHARTS = [
  { id: "renko-30m", title: "BTC Renko 30m", interval: "30m", historyLimit: 18000, fallbackSeconds: 1800, type: "renko", boxSize: BTC_RENKO_THIRTY_MINUTE_BOX_SIZE, bbColor: "#7c3aed", bbMultiplier: 3, bbPeriod: 10000, extraBollingerBands: [{ color: "#38bdf8", middleColor: "#ffffff", period: 8000, multiplier: 2, showMiddle: true }], projectedDownColor: "#f59e0b", projectedUpColor: "#38bdf8", showBollingerBands: true, showBbMiddle: false, showEma: false, showVwma: false, visibleBars: 700 },
  { id: "candles-30m-lsma", title: "BTC 1H", interval: "1h", historyLimit: 4000, fallbackSeconds: 3600, type: "candles", lsmaPeriod: 1400, extraLsmaPeriod: 1700, pivots: { type: "woodie", timeframe: "monthly", periodsBack: 3, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false, visibleBars: 450 },
...
export const ALT_HISTORY_LIMIT = 1800;
