...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-1m", title: "BTC 1m", interval: "1m", historyLimit: 10000, fallbackSeconds: 60, type: "candles", bbMultiplier: BTC_ONE_MINUTE_BB_MULTIPLIER, bbPeriod: BTC_ONE_MINUTE_BB_PERIOD, extraBollingerBands: [{ color: "#38bdf8", middleColor: "#ffffff", period: 3000, multiplier: 2, showMiddle: true }, { color: "#7c3aed", period: 4000, multiplier: 3 }], showBollingerBands: true, showEma: false, showVwma: false, stochRsi: { rsiPeriod: 200, stochPeriod: 300, smoothK: 21, smoothD: 15 } },
