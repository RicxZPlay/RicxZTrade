...
export const BTC_ONE_SECOND_LSMA_PERIOD = 1900;
export const BTC_ONE_SECOND_LSMA_OFFSET = 55;
...
export const BTC_QUAD_CHARTS = [
  { id: "candles-1s", title: "BTC 1s", interval: "1s", historyLimit: 5000, fallbackSeconds: 1, type: "candles", lsmaOffset: BTC_ONE_SECOND_LSMA_OFFSET, lsmaPeriod: BTC_ONE_SECOND_LSMA_PERIOD, showBollingerBands: false, showEma: false, vwmaPeriod: BTC_ONE_SECOND_VWMA_PERIOD },
