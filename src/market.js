...
export const BTC_QUAD_CHARTS = [
  ...
  { id: "candles-15m-lsma", title: "BTC 15m", interval: "15m", historyLimit: 4200, fallbackSeconds: 900, type: "candles", maPeriod: 800, extraLsmaPeriod: BTC_SLOW_SETUP_LSMA_PERIOD, pivots: { type: "woodie", timeframe: "monthly", periodsBack: 3, color: "#f59e0b" }, showBollingerBands: false, showEma: false, showVwma: false, visibleBars: 450 },
...
export const ALT_CHART_INTERVALS = {
  "15m": { interval: "15m", historyLimit: 4200, fallbackSeconds: 900 },
};
export const ALT_CHART_VISIBLE_CANDLES = 4200;
